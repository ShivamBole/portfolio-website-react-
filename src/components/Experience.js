...
const cardVariants = {
  hidden: (index) => ({
    opacity: 0,
    x: index % 2 === 0 ? -160 : 160, // ⬅ more distance
  }),
  visible: (index) => ({
    opacity: 1,
    x: 0,
    transition: {
      ...
      stiffness: 70,         // ⬅ lower = slower
      damping: 18,           // ⬅ higher = smoother stop
      mass: 0.9,
      delay: index * 0.05,   // ⬅ cinematic delay
    },
  }),
};
  ...
  return (
    <section id="experience" className="py-20">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="h2 text-marsBlue">Professional Experience</h2>
          <p className="mt-4 max-w-xl mx-auto">
            Hands-on experience building and delivering real-world MERN stack
