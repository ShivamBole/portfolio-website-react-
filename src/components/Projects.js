    ...
    <div>
      <section id="work">
        <div className="container mx-auto relative  ">
          <div className="flex flex-row gap-x-10 text-center text-2xl mt-5">
            {/* <div className="gradient my-2 content-center p-4 rounded-full">
              <Link to="/" >
          ...
          <div className="flex flex-col lg:flex-col gap-y-10 text-center">
            ...
            >
              ...
              <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl flex">
                ...
                <div className="absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50">
                  <a
                    href="https://github.com/ShivamBole/calculator-codsoft"
                    target="_blank"
                  >
            ...
            >
              <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl flex">
                ...
                <div className="absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50">
                  <a
                    href="https://github.com/ShivamBole/jokes-website.git"
                    target="_blank"
                  >
                ...
                <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50">
                  <a
                    ...
                    target="_blank"
                  >
                    <span className="text-3xl text-white">JOKES WEBSITE</span>
                  </a>
                </div>
              </div>
              <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl flex">
                ...
                <div className="absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50">
                  <a
                    href="https://github.com/ShivamBole/rock-paper-scissor-game.git"
                    target="_blank"
                  >
          ...
          <div className="flex flex-col lg:flex-col gap-y-10 text-center mt-5">
            ...
            >
              ...
              <div className="group relative overflow-hidden border-2 border-white/50 rounded-xl flex">
                ...
                <div className="absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50">
                  <a href="https://musiera.netlify.app/" target="_blank">
                    <span className="text-gradient">TEXT EDITOR WEBSITE</span>
                  </a>
                </div>
                <div className="absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50">
                  <a href="https://musiera.netlify.app/" target="_blank">
                    <span className="text-3xl text-white">TEXTUTIL</span>
                  </a>
                </div>
              </div>
            </motion.div>
